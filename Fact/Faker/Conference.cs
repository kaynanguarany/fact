...
namespace Fact.Faker
{
    ...
    {
        public static string Title => CONFERENCE_LIST.Rand();


        private static string[] CONFERENCE_LIST = {
            "Social Mobile Payments Americas",
            "LatAm HSE in Oil, Gas and Petrochemicals",
            "LatAm Pipeline Integrity Management Summit", "1st UK Festival de Orquestas",
            ...
            "4th Annual Utility Scale Solar 2011", "BioPharm America 2011",
